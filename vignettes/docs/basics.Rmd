...
hyp_obj <- hypeR(ranked.signature, gsets, test="kstest", fdr_cutoff=0.05, do_plots=TRUE)
hyp_obj$plots[[1]]
...
hyp_obj <- hypeR(weighted.signature, gsets, test="kstest", fdr_cutoff=0.05, do_plots=TRUE)
hyp_obj$plots[[1]]
