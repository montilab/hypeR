...
### Hyper enrichment
All workflows begin with performing hyper enrichment with `hypeR`. Note that when passing an `rgsets` object, ensure `gsets_relational=TRUE`. Otherwise, `hypeR` will treat it as a list of unstructured gsets. 
```{r}
