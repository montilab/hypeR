...
```{r, eval=FALSE}
BIOCARTA <- msigdb_gsets(category="C2", subcategory="CP:BIOCARTA")
KEGG     <- msigdb_gsets(category="C2", subcategory="CP:KEGG")
REACTOME <- msigdb_gsets(category="C2", subcategory="CP:REACTOME")
```
