...
- name: Anthony Federico
  affiliation:
  - &1 Bioinformatics Department, Boston University, Boston, MA
  - &2 Section of Computational Biomedicine, Boston University, Boston, MA
- name: Stefano Monti
  affiliation:
  - *1
  - *2
...
hyp.obj <- hypeR(symbols, gsets, bg=7842, fdr=0.05)
...
hyp_to_excel(hyp.obj, file.path="pathways.xlsx")
...
hyp_to_table(hyp.obj, file.path="pathways.txt")
...
hyp.obj <- hypeR(symbols, gsets, bg=bg)
