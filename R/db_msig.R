...
#'
#' @param species A species to determine gene symbols (refer to ?msigdbr::msigdbr for avilable species)
#' @param collection Geneset collection (previous argument "category" is deprecated. refer to ?msigdbr::msigdbr for avilable collections)
#' @param subcollection Geneset subcollection (previous argument "subcategory" is deprecated. refer to ?msigdbr::msigdbr for avilable subcollections)
...
#' @importFrom msigdbr msigdbr
#' @export
msigdb_download <- function(species, collection, subcollection="") {
...
#'
#' @export
msigdb_gsets <- function(species, collection, subcollection="", clean=FALSE) {
